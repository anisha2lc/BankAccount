  ...
  return (
    <div className="md:min-h-screen w-full flex md:flex-row flex-col  ">
      ...
      <div className=" flex-1 flex justify-center mt-3 h-auto ">
        {tab === "details" ? (
          <div>
            <div className=" md:w-[600px] text-white bg-[url('https://imgs.search.brave.com/MsG-kGOzogJfsW3uV_t8Oz38yBIdrh2KVt1VdVOEd9U/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/ZnJlZS1waG90by9y/ZWQtZ3J1bmdlLWJh/Y2tncm91bmRfMTA0/OC04OTYwLmpwZz9z/aXplPTYyNiZleHQ9/anBn')] bg-white border h-52 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                <img
            ...
            <div className="w-full p-4">
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="border-[1px] bg-gradient-to-r from-red-500 to-black-500 text-gray-700 border-red-600 cursor-pointer px-4 py-2 rounded-lg shadow-lg">
                  <div className="flex flex-col gap-1 text-gray-500">
                    <span className="font-bold text-xl">Account Status</span>
                ...
                <div className="border-[1px] bg-white text-gray-700 border-red-600 cursor-pointer px-4 py-2  rounded-lg shadow">
                  <div className=" flex flex-col gap-1 text-cyan-700">
                    ...
                    <span className="inline-flex items-center bg-green-500 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full ">
                      <span className="w-2 h-2 me-1 bg-green-800 rounded-full"></span>
                      Active
                    </span>
                  </div>
                </div>
            ...
            <div className=" border-2 border-sky-500 rounded-lg pb-4 flex justify-center mt-10 flex-col gap-4 items-center">
